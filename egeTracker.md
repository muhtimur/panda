...
|------|--------|-----------------|
| **1** | Настройка Flask, базы данных, моделей | 2–3 дня |
| **2** | Аутентификация (регистрация, вход, профиль) | 2 дня |
| **3** | Ядро: ежедневный чек-ин и форма заданий | 3–4 дня |
| **4** | Тепловая карта (GitHub-style) | 2–3 дня |
| **5** | Система достижений (логика и UI) | 2–3 дня |
| **6** | Статистика и графики (Chart.js) | 2 дня |
| **7** | UI/UX, адаптивность (Bootstrap) | 2–3 дня |
| **8** | Тестирование, деплой (PythonAnywhere/Render) | 2 дня |

**Итого:** ~3–4 недели при ежедневной работе 1–2 часа
